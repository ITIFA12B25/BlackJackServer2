...
""));
        ...
        lblWinner->setGeometry(QRect(230, 90, 261, 71));
        QFont font10;
        font10.setFamilies({QString::fromUtf8("Comic Sans MS")});
        font10.setPointSize(14);
        font10.setBold(false);
        lblWinner->setFont(font10);
        lblRoomInfo->raise();
        lblStatus->raise();
